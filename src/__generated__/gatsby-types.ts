...
export type DataJson = Node & {
  ...
  readonly contacts: Maybe<DataJsonContacts>;
  readonly careers: Maybe<ReadonlyArray<Maybe<DataJsonCareers>>>;
  readonly categories: Maybe<ReadonlyArray<Maybe<DataJsonCategories>>>;
};

export type DataJsonCareers = {
  readonly name: Maybe<Scalars['String']>;
  readonly summary: Maybe<Scalars['String']>;
  readonly department: Maybe<Scalars['String']>;
  readonly start_date: Maybe<Scalars['String']>;
  readonly ent_date: Maybe<Scalars['String']>;
  readonly position: Maybe<Scalars['String']>;
  readonly projects: Maybe<ReadonlyArray<Maybe<DataJsonCareersProjects>>>;
};

export type DataJsonCareersFilterInput = {
  readonly name: Maybe<StringQueryOperatorInput>;
  readonly summary: Maybe<StringQueryOperatorInput>;
  readonly department: Maybe<StringQueryOperatorInput>;
  readonly start_date: Maybe<StringQueryOperatorInput>;
  readonly ent_date: Maybe<StringQueryOperatorInput>;
  readonly position: Maybe<StringQueryOperatorInput>;
  readonly projects: Maybe<DataJsonCareersProjectsFilterListInput>;
};

export type DataJsonCareersFilterListInput = {
  readonly elemMatch: Maybe<DataJsonCareersFilterInput>;
};

export type DataJsonCareersProjects = {
  readonly name: Maybe<Scalars['String']>;
  readonly start_date: Maybe<Scalars['String']>;
...
export type DataJsonCareersProjectsFilterInput = {
  readonly name: Maybe<StringQueryOperatorInput>;
  readonly start_date: Maybe<StringQueryOperatorInput>;
  readonly end_date: Maybe<StringQueryOperatorInput>;
  readonly summary: Maybe<StringQueryOperatorInput>;
  readonly link: Maybe<StringQueryOperatorInput>;
};

export type DataJsonCareersProjectsFilterListInput = {
  readonly elemMatch: Maybe<DataJsonCareersProjectsFilterInput>;
};

export type DataJsonCategories = {
  readonly name: Maybe<Scalars['String']>;
  readonly contents: Maybe<ReadonlyArray<Maybe<DataJsonCategoriesContents>>>;
};

export type DataJsonCategoriesContents = {
  readonly title: Maybe<Scalars['String']>;
  readonly description: Maybe<Scalars['String']>;
};

export type DataJsonCategoriesContentsFilterInput = {
  readonly title: Maybe<StringQueryOperatorInput>;
  readonly description: Maybe<StringQueryOperatorInput>;
};

export type DataJsonCategoriesContentsFilterListInput = {
  readonly elemMatch: Maybe<DataJsonCategoriesContentsFilterInput>;
};

export type DataJsonCategoriesFilterInput = {
  readonly name: Maybe<StringQueryOperatorInput>;
  readonly contents: Maybe<DataJsonCategoriesContentsFilterListInput>;
};

export type DataJsonCategoriesFilterListInput = {
  readonly elemMatch: Maybe<DataJsonCategoriesFilterInput>;
};
...
export type DataJsonContactsFilterInput = {
...
export enum DataJsonFieldsEnum {
  ...
  author = 'author',
  Introduce = 'Introduce',
  contacts___github = 'contacts.github',
  contacts___phone = 'contacts.phone',
  contacts___mail = 'contacts.mail',
  contacts___blog = 'contacts.blog',
  careers = 'careers',
  careers___name = 'careers.name',
  careers___summary = 'careers.summary',
  careers___department = 'careers.department',
  careers___start_date = 'careers.start_date',
  careers___ent_date = 'careers.ent_date',
  careers___position = 'careers.position',
  careers___projects = 'careers.projects',
  careers___projects___name = 'careers.projects.name',
  careers___projects___start_date = 'careers.projects.start_date',
  careers___projects___end_date = 'careers.projects.end_date',
  careers___projects___summary = 'careers.projects.summary',
  careers___projects___link = 'careers.projects.link',
  categories = 'categories',
  categories___name = 'categories.name',
  categories___contents = 'categories.contents',
  categories___contents___title = 'categories.contents.title',
  categories___contents___description = 'categories.contents.description'
}
...
export type DataJsonFilterInput = {
  ...
  readonly Introduce: Maybe<StringQueryOperatorInput>;
  readonly contacts: Maybe<DataJsonContactsFilterInput>;
  readonly careers: Maybe<DataJsonCareersFilterListInput>;
  readonly categories: Maybe<DataJsonCategoriesFilterListInput>;
};
...
export enum FileFieldsEnum {
  ...
  childDataJson___title = 'childDataJson.title',
  childDataJson___subTitle = 'childDataJson.subTitle',
  childDataJson___author = 'childDataJson.author',
  childDataJson___Introduce = 'childDataJson.Introduce',
  childDataJson___contacts___github = 'childDataJson.contacts.github',
  childDataJson___contacts___phone = 'childDataJson.contacts.phone',
  childDataJson___contacts___mail = 'childDataJson.contacts.mail',
  childDataJson___contacts___blog = 'childDataJson.contacts.blog',
  childDataJson___careers = 'childDataJson.careers',
  childDataJson___careers___name = 'childDataJson.careers.name',
  childDataJson___careers___summary = 'childDataJson.careers.summary',
  childDataJson___careers___department = 'childDataJson.careers.department',
  childDataJson___careers___start_date = 'childDataJson.careers.start_date',
  childDataJson___careers___ent_date = 'childDataJson.careers.ent_date',
  childDataJson___careers___position = 'childDataJson.careers.position',
  childDataJson___careers___projects = 'childDataJson.careers.projects',
  childDataJson___careers___projects___name = 'childDataJson.careers.projects.name',
  childDataJson___careers___projects___start_date = 'childDataJson.careers.projects.start_date',
  childDataJson___careers___projects___end_date = 'childDataJson.careers.projects.end_date',
  childDataJson___careers___projects___summary = 'childDataJson.careers.projects.summary',
  childDataJson___careers___projects___link = 'childDataJson.careers.projects.link',
  childDataJson___categories = 'childDataJson.categories',
  childDataJson___categories___name = 'childDataJson.categories.name',
  childDataJson___categories___contents = 'childDataJson.categories.contents',
  childDataJson___categories___contents___title = 'childDataJson.categories.contents.title',
  childDataJson___categories___contents___description = 'childDataJson.categories.contents.description'
}
...
export type Query_dataJsonArgs = {
  ...
  Introduce: Maybe<StringQueryOperatorInput>;
  contacts: Maybe<DataJsonContactsFilterInput>;
  careers: Maybe<DataJsonCareersFilterListInput>;
  categories: Maybe<DataJsonCategoriesFilterListInput>;
};
